  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-8 xl:grid-cols-[1.35fr,0.8fr]">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <button className="inline-flex items-center gap-2 rounded-full bg-moss px-5 py-3 text-sm font-semibold text-forest-950 transition hover:scale-[1.02]">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.3fr,0.9fr]">
        <PanelCard title="Recent alerts" subtitle="Latest threat, fire, movement, and logging alerts across monitored zones">
